    ...
    <main>
      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className="fixed top-[13%] right-[3%] z-10 border rounded-full bg-slate-200 flex justify-center items-center w-12 h-12 cursor-pointer">
            <FaShare
          ...
          <div className="flex flex-col max-w-4xl gap-4 p-3 mx-auto my-7">
            ...
            {currentUser && listing.userRef !== currentUser._id && !contact && (
              <button
                ...
                className="p-3 text-white uppercase rounded-md bg-slate-700 hover:opacity-95"
              >
                Contact Landlord
              </button>
            )}
